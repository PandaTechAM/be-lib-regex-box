...
public static class PandaValidator
{
    ...
    private static readonly Regex ArmenianSocialSecurityNumber =
    ...
    public static bool IsArmenianSocialSecurityNumber(string socialCardNumber)
    {
        return ArmenianSocialSecurityNumber.IsMatch(socialCardNumber);
    }
}